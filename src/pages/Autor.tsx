            ...
            <div>
              ...
              <div className="space-y-6 mt-6">
                ...
                <div className="bg-destructive -mx-6 px-6 py-8 rounded-lg">
                  ...
                  <p className="bible-body font-bold text-destructive-foreground text-center">Não é um logo para ser lembrado, é uma ideia para ser compreendida — tarde demais.</p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-6 mt-6">
                ...
                <div className="bg-destructive -mx-6 px-6 py-8 rounded-lg">
                  ...
                  <p className="bible-body font-bold text-destructive-foreground text-center">It's not a logo to be remembered, it's an idea to be understood — too late.</p>
                </div>
              </div>
            </div>
          </div>
