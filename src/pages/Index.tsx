  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main>
        ...
        {/* ===== CREATIVE AI FRAMEWORK - GRID 2x2 ===== */}
        <section className="py-16 px-4">
          <div className="container mx-auto max-w-7xl">
            <div className="grid md:grid-cols-2 gap-8">
              
              {/* Card 1: As Três Leis da Robótica Criativa */}
              <Card className="p-8 bg-card/50 backdrop-blur-sm border-primary/20 hover:border-primary/40 transition-all">
                <h3 className="text-2xl font-bold mb-6 text-foreground flex items-center gap-3">
                  ...
                  As Três Leis da Robótica Criativa
                </h3>
                <h4 className="text-lg font-semibold mb-4 text-muted-foreground">
                  The Three Laws of Creative Robotics
                </h4>
                
                <div className="space-y-4 text-sm leading-relaxed">
                  <div className="border-l-2 border-primary/50 pl-4">
                    <p className="font-semibold text-primary mb-1">01: Uma máquina não prejudicará a criatividade humana</p>
                  ...
                  <div className="border-l-2 border-primary/50 pl-4">
                    <p className="font-semibold text-primary mb-1">02: Uma máquina deve amplificar a intenção criativa humana</p>
                    <p className="text-muted-foreground">
                  ...
                  <div className="border-l-2 border-primary/50 pl-4">
                    <p className="font-semibold text-primary mb-1">03: Uma máquina deve preservar seu potencial criativo</p>
                    <p className="text-muted-foreground">
                ...
                <p className="mt-6 text-xs text-muted-foreground italic">
                  Adaptação livre das Três Leis da Robótica de Isaac Asimov, aplicadas ao contexto da co-criação humano-máquina. / 
                  Free adaptation of Isaac Asimov's Three Laws of Robotics applied to human-machine co-creation context.
                </p>
              </Card>

              {/* Card 2: Processo de Criação Híbrida com IA */}
              <Card className="p-8 bg-card/50 backdrop-blur-sm border-primary/20 hover:border-primary/40 transition-all">
                <h3 className="text-2xl font-bold mb-6 text-foreground flex items-center gap-3">
                ...
                <h4 className="text-lg font-semibold mb-4 text-muted-foreground">
                  Hybrid AI Creation Process
                </h4>
                
                <div className="space-y-3 text-sm leading-relaxed">
                  <div>
                    <p className="font-semibold text-foreground mb-1">
                      <span className="text-primary">PORTUGUÊS:</span> Este memorial artístico documenta um processo de criação híbrida entre humano e inteligência artificial em constante desenvolvimento.
                    </p>
                    <p className="text-muted-foreground">
                      A trajetória começa em 2008 com a fundação da CasaTrezeStudio, passa pelo desenvolvimento do filme LowMovie™ (2020-2023), 
                      pelo mestrado em Cinema e Artes do Vídeo (iniciado em 2024), e culmina neste portal digital (outubro 2025 - presente).
                    </p>
                  </div>
                  ...
                  <div>
                    <p className="font-semibold text-foreground mb-1">
                      <span className="text-primary">ENGLISH:</span> This artistic memorial documents a hybrid creation process between human and artificial intelligence in constant development.
                    </p>
                    <p className="text-muted-foreground">
                      The trajectory begins in 2008 with the foundation of CasaTrezeStudio, passes through the development of the LowMovie™ film (2020-2023), 
                      the Master's in Cinema and Video Arts (started in 2024), and culminates in this digital portal (October 2025 - present).
                    </p>
                  </div>

                  <div className="mt-4 pt-4 border-t border-primary/20">
                    <p className="text-xs text-muted-foreground italic">
                      Não se trata de usar IA como ferramenta passiva, mas de estabelecer um diálogo criativo onde a máquina atua como co-criadora, 
                      desafiando, propondo e expandindo o universo conceitual do THEVØIDN13. Um coletivo, de humano-humano para humano-máquina.
                    </p>
                  </div>
                </div>
              </Card>

              {/* Card 3: Fluxo de Trabalho Híbrido */}
              <Card className="p-8 bg-card/50 backdrop-blur-sm border-primary/20 hover:border-primary/40 transition-all">
                <h3 className="text-2xl font-bold mb-6 text-foreground flex items-center gap-3">
                ...
                <div className="space-y-4 text-sm">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-semibold text-foreground">Observação</p>
                      <p className="text-muted-foreground">Mergulho introspectivo no vazio pessoal. Identificação de sintomas, ruídos internos, fragmentos visuais do inconsciente. 
                      Registro em cadernos analógicos e notas de áudio.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-semibold text-foreground">Co-criação</p>
                      <p className="text-muted-foreground">Diálogo com IAs (GPT-5, Claude, Gemini, Midjourney). Prompts não como "comandos" mas como perguntas abertas. 
                      A proposta, desafia, expande. O humano filtra, recombina, reconstrói.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">Tudo é registrado. Cada prompt, cada imagem descartada, cada erro, cada acidente feliz. 
                      O processo é mais importante que o produto final. O memorial não é retrospectivo — ele acontece em tempo real.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-semibold text-foreground">Manifestação</p>
                      <p className="text-muted-foreground">Tudo é registrado. Textos filosóficos, design gráfico, código, som. Publicação contínua via GitHub, 
                      garantindo transparência e rastreabilidade do processo. Um corpo que respira através do colapso traduzindo peso em som puro.</p>
                    </div>
                  </div>
                </div>
              </Card>

              {/* Card 4: Stack Técnico Detalhado */}
              <Card className="p-8 bg-card/50 backdrop-blur-sm border-primary/20 hover:border-primary/40 transition-all">
                <h3 className="text-2xl font-bold mb-6 text-foreground flex items-center gap-3">
                ...
                <div className="space-y-4 text-sm">
                  <div>
                    <p className="font-semibold text-primary mb-2">Frontend / Interface</p>
                    <p className="text-muted-foreground leading-relaxed">
                      <strong>React</strong> + <strong>TypeScript</strong> + <strong>Vite</strong> — Arquitetura moderna e type-safe. 
                      <strong>Tailwind CSS</strong> + <strong>shadcn/ui</strong> — Design system customizado. 
                      <strong>React Router</strong> — Navegação client-side.
                    </p>
                  </div>

                  <div>
                    <p className="font-semibold text-primary mb-2">Backend (Lovable Cloud)</p>
                    <p className="text-muted-foreground leading-relaxed">
                      <strong>Supabase</strong> — Auth, DB, Edge Functions. 
                      <strong>Deno</strong> — Runtime para serverless functions. 
                      <strong>Vimeo API</strong> — Streaming de vídeos.
                    </p>
                  </div>

                  <div>
                    <p className="font-semibold text-primary mb-2">Co-criação com IA</p>
                    <p className="text-muted-foreground leading-relaxed">
                      <strong>Lovable AI</strong> (Claude + Gemini) — Geração de texto/código. 
                      <strong>Midjourney</strong> + <strong>Adobe Firefly</strong> — Geração de imagens. 
                      <strong>Google AI Studio</strong> — Experimentação com modelos generativos.
                    </p>
                  </div>

                  <div>
                    <p className="font-semibold text-primary mb-2">Asset Management</p>
                    <p className="text-muted-foreground leading-relaxed">
                      <strong>Vimeo</strong> — Hospedagem e streaming de vídeos. 
                      <strong>Local Assets</strong> — Imagens otimizadas em /src/assets/. 
                      <strong>Public Documents</strong> — PDFs e arquivos em /public/documents/.
                    </p>
                  </div>

                  <div>
                    <p className="font-semibold text-primary mb-2">Deployment & Hosting</p>
                    <p className="text-muted-foreground leading-relaxed">
                      <strong>Lovable Platform</strong> — Deploy automático via Git push. 
                      <strong>Cloudflare</strong> — CDN global e SSL. 
                      <strong>GitHub</strong> — Controle de versão e documentação pública.
                    </p>
                  </div>
                </div>
              </Card>
