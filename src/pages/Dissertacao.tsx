...
const Dissertacao = () => {
  ...
  return <div className="min-h-screen bg-background text-foreground">
      ...
      <main>
        ...
        <BilingualSection className="py-8">
          <BilingualContent portugueseContent={<p className="site-paragraph">
                Subjetividade, Subcultura e a Construção de uma Estética em Movimento no Coletivo LowPressure™
              </p>} englishContent={<p className="site-paragraph">
        ...
        <BilingualSection>
          <div className="space-y-4 mb-16">
            ...
            <BilingualContent portugueseContent={<p className="site-paragraph text-muted-foreground">
                ...
                </p>} englishContent={<p className="site-paragraph text-muted-foreground">
        ...
        <BilingualSection>
          <div className="border-l-4 border-primary pl-6 space-y-8">
            <div>
              <h2 className="site-title mb-2">CasaTrezeStudio</h2>
              <p className="site-subtitle text-muted-foreground mb-2">2008-Presente</p>
              <p className="site-subtitle text-primary">Coletivo Criativo / Creative Lab</p>
            </div>
            ...
            <BilingualContent portugueseContent={<div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <h3 className="site-subtitle text-primary">Conceito / Concept</h3>
                    <p className="site-paragraph">
                  ...
                  <div className="space-y-4">
                    <h3 className="site-subtitle text-primary">Serviços / Services</h3>
                    <div className="space-y-2">
                      <p className="site-paragraph"><span className="font-bold text-primary">Design Gráfico:</span> Identidades visuais, branding, editorial</p>
                      <p className="site-paragraph"><span className="font-bold text-primary">Vídeo:</span> Documentários, videoclipes, conteúdo digital</p>
                      <p className="site-paragraph"><span className="font-bold text-primary">Direção de Arte:</span> Projetos culturais, campanhas, eventos</p>
                      <p className="site-paragraph"><span className="font-bold text-primary">Curadoria:</span> Projetos experimentais e autorais</p>
                    </div>
                  </div>

                  <div className="space-y-4">
                    <h3 className="site-subtitle text-primary">Filosofia / Philosophy</h3>
                    <p className="site-paragraph">
                  ...
                  <div className="space-y-4">
                    <h3 className="site-subtitle text-primary">Serviços / Services</h3>
                      <div className="space-y-2">
                        <p className="site-paragraph"><span className="font-bold text-primary">Graphic Design:</span> Visual identities, branding, editorial</p>
                        <p className="site-paragraph"><span className="font-bold text-primary">Video:</span> Documentaries, music videos, digital content</p>
                        <p className="site-paragraph"><span className="font-bold text-primary">Art Direction:</span> Cultural projects, campaigns, events</p>
                        <p className="site-paragraph"><span className="font-bold text-primary">Curation:</span> Experimental and authorial projects</p>
                      </div>
                  </div>
        ...
        <BilingualSection>
          <div className="border-l-4 border-primary pl-6 space-y-8">
              <div>
                ...
                <p className="site-subtitle text-muted-foreground mb-2">2020-Presente</p>
                <p className="site-subtitle text-primary">Skate Crew / Movimento Cultural</p>
              </div>
            ...
            <BilingualContent portugueseContent={<div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <p className="site-paragraph mt-4">
                  ...
                  <div className="space-y-4">
                    <h3 className="site-subtitle text-primary">História / History</h3>
                    <p className="site-paragraph">
                  ...
                  <div className="space-y-4">
                    <h3 className="site-subtitle text-primary">Propósito / Purpose</h3>
                    <p className="site-paragraph">
        ...
        <BilingualSection>
          <div className="border-l-4 border-primary pl-6 space-y-8">
            <div>
              <h2 className="site-title mb-2">LowMovie</h2>
              <p className="site-subtitle text-muted-foreground mb-2">2019-Presente</p>
              <p className="site-subtitle text-primary">Full Video / Filme-Processo</p>
            </div>
            ...
            <BilingualContent portugueseContent={<div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <h3 className="site-subtitle text-primary">Simbolismo / Symbolism</h3>
                    <p className="site-paragraph">
                  ...
                  <div className="space-y-4">
                    <h3 className="site-subtitle text-primary">Premiére / Premiere</h3>
                    <p className="site-paragraph">
                  ...
                  <div className="space-y-4">
                    <h3 className="site-subtitle text-primary">Lowbyrinth™</h3>
                    <p className="site-paragraph">
        ...
        <BilingualSection>
          <BilingualContent portugueseContent={<>
                <h2 className="site-title">Introdução / Rastros nas Ruas</h2>
                <p className="site-paragraph mt-6">
                ...
                <h2 className="site-title">Introduction / Traces in the Streets</h2>
                <p className="site-paragraph mt-6">
        ...
        <BilingualSection>
          <BilingualContent portugueseContent={<>
                <h2 className="site-title">A VideoParte como Linguagem</h2>
                <p className="site-paragraph mt-6">
                ...
                <h2 className="site-title">The VideoPart as Language</h2>
                <p className="site-paragraph mt-6">
        ...
        <BilingualSection>
          <BilingualContent portugueseContent={<div className="space-y-8">
                ...
                <div className="space-y-6">
                  <div>
                    <h3 className="site-subtitle mb-3">Pesquisa em Arte como Práxis Sensível</h3>
                    <p className="site-paragraph">
                  ...
                  <div>
                    <h3 className="site-subtitle mb-3">Estrutura em Três Movimentos</h3>
                    <p className="site-paragraph mb-4">
                    ...
                    <div className="pl-6 space-y-3">
                      <div className="border-red-left">
                        <p className="bordered-title">Movimento I — Corpo em Deriva</p>
                        <p className="bordered-description">Investiga o corpo do skatista em relação ao espaço urbano, explorando a dimensão performática e sensível do gesto.</p>
                      </div>
                      <div className="border-red-left">
                        <p className="bordered-title">Movimento II — Coletivo em Baixo Relevo</p>
                        <p className="bordered-description">Examina as dinâmicas colaborativas da crew LowPressure™, seus modos de criação partilhada e pertencimento estético.</p>
                      </div>
                      <div className="border-red-left">
                        <p className="bordered-title">Movimento III — Obra em Expansão</p>
                        <p className="bordered-description">Analisa o LowMovie™ como dispositivo audiovisual que transborda o formato convencional e se desdobra em outras materialidades.</p>
                      </div>
                    </div>
                  </div>

                  <div>
                    <h3 className="site-subtitle mb-3">Lowbyrinth™: O Labirinto como Orientação Metodológica</h3>
                    <p className="site-paragraph">
                  ...
                  <div>
                    <h3 className="site-subtitle mb-3">Três Procedimentos Metodológicos</h3>
                    <div className="space-y-4">
                      <div className="bg-background/50 p-4 rounded-lg border border-border/50">
                        <p className="bordered-title mb-2">1. Vivência Situada em Processos Coletivos</p>
                        <p className="bordered-description">
                      ...
                      <div className="bg-background/50 p-4 rounded-lg border border-border/50">
                        <p className="bordered-title mb-2">2. Convivência Criativa no Campo</p>
                        <p className="bordered-description">
                      ...
                      <div className="bg-background/50 p-4 rounded-lg border border-border/50">
                        <p className="bordered-title mb-2">3. Escuta Compartilhada</p>
                        <p className="bordered-description">
                  ...
                  <div>
                    <h3 className="site-subtitle mb-3">Escuta como Operação Epistemológica</h3>
                    <p className="site-paragraph">
                  ...
                  <div>
                    <h3 className="site-subtitle mb-3">Criação como Pesquisa</h3>
                    <p className="site-paragraph">
                ...
                <h2 className="site-title">Methodology / Lowbyrinth™ as Method</h2>
                
                <div className="space-y-6">
                  <div>
                    <h3 className="site-subtitle mb-3">Research in Art as Sensitive Praxis</h3>
                    <p className="site-paragraph">
                  ...
                  <div>
                    <h3 className="site-subtitle mb-3">Structure in Three Movements</h3>
                    <p className="site-paragraph mb-4">
                    ...
                    <div className="pl-6 space-y-3">
                      <div className="border-red-left">
                        <p className="bordered-title">Movement I — Body in Drift</p>
                        <p className="bordered-description">Investigates the skater's body in relation to urban space, exploring the performative and sensitive dimension of gesture.</p>
                      </div>
                      <div className="border-red-left">
                        <p className="bordered-title">Movement II — Collective in Low Relief</p>
                        <p className="bordered-description">Examines the collaborative dynamics of the LowPressure™ crew, their modes of shared creation and aesthetic belonging.</p>
                      </div>
                      <div className="border-red-left">
                        <p className="bordered-title">Movement III — Work in Expansion</p>
                        <p className="bordered-description">Analyzes LowMovie™ as an audiovisual device that overflows the conventional format and unfolds into other materialities.</p>
                      </div>
                    </div>
                  </div>

                  <div>
                    <h3 className="site-subtitle mb-3">Lowbyrinth™: The Labyrinth as Methodological Orientation</h3>
                    <p className="site-paragraph">
                  ...
                  <div>
                    <h3 className="site-subtitle mb-3">Three Methodological Procedures</h3>
                    <div className="space-y-4">
                      <div className="bg-background/50 p-4 rounded-lg border border-border/50">
                        <p className="bordered-title mb-2">1. Situated Experience in Collective Processes</p>
                        <p className="bordered-description">
                      ...
                      <div className="bg-background/50 p-4 rounded-lg border border-border/50">
                        <p className="bordered-title mb-2">2. Creative Coexistence in the Field</p>
                        <p className="bordered-description">
                      ...
                      <div className="bg-background/50 p-4 rounded-lg border border-border/50">
                        <p className="bordered-title mb-2">3. Shared Listening</p>
                        <p className="bordered-description">
                  ...
                  <div>
                    <h3 className="site-subtitle mb-3">Listening as Epistemological Operation</h3>
                    <p className="site-paragraph">
                  ...
                  <div>
                    <h3 className="site-subtitle mb-3">Creation as Research</h3>
                    <p className="site-paragraph">
        ...
        <BilingualSection>
          <BilingualContent portugueseContent={<>
                <h2 className="site-title">Corpo e Cidade</h2>
                <p className="site-paragraph mt-6">
                ...
                <h2 className="site-title">Body and City</h2>
                <p className="site-paragraph mt-6">
        ...
        <BilingualSection>
          <BilingualContent portugueseContent={<>
                <h2 className="site-title">Mestrado em Cinema e Artes do Vídeo</h2>
                <p className="site-paragraph mt-6">
                ...
                <p className="site-paragraph mt-6 font-medium">
                  Orientador: Prof. Dr. Fábio Jabur de Noronha
                </p>
                <p className="site-paragraph font-medium">
                ...
                <h2 className="site-title">Master's in Cinema and Video Arts</h2>
                <p className="site-paragraph mt-6">
        ...
        <BilingualSection>
          <div className="space-y-16">
            <div className="space-y-4">
              ...
              <h3 className="site-subtitle text-primary">Documentos de Pesquisa / Research Documents</h3>
            </div>
        ...
        <BilingualSection>
          <div className="space-y-8">
            <div className="space-y-2">
              <h2 className="site-title">Colaboração e Coletivos / Collaboration and Collectives</h2>
            </div>
